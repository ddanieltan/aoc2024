...
def parse(inp:str) -> tuple[dict, list]:
    top, bot = inp.split("\n\n")

    # Rules contain all the numbers (values) that cannot come on the left of (key)
...
def part1(inp:str) -> int:
    ...
    for line in lines:
        ...
        for i, num in enumerate(line):
            ...
            must_be_left = rules[num] # <1> Can't use .get
...
def parse_good_rules(inp:str) -> dict:
    top, bot = inp.split("\n\n")
...
def part2(inp:str) -> int:
    ...
    good_rules = parse_good_rules(inp)
