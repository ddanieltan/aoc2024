...
![Prompt: The letters "X", "M", "A", "S" repeated multiple times in a grid in christmas colours](images/01.webp){width="500" fig-align="center"}
...
def part2(inp:str) -> int:
    ...
    def check_corner_letters(x:int, y:int) -> tuple | None:
